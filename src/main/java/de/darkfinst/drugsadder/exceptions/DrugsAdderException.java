...
public abstract class DrugsAdderException extends RuntimeException{
     ...
     */
    public DrugsAdderException(String message) {
        super(message);
    }
     ...
     *                unknown.)
     */
    public DrugsAdderException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *              unknown.)
     */
    public DrugsAdderException(Throwable cause) {
        super(cause);
    }
